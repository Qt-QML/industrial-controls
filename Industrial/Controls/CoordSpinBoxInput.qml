...
Item {
    ...
    Row {
        ...
        NumericInput {
            ...
            height: root.height
            overwriteMode: true
            selectionColor: highlighter.visible ? highlighter.color : industrial.controlColor
            selectedTextColor: highlighter.visible ? industrial.onSelectionColor : industrial.onContainerColor
