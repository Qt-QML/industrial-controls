...
QColor Palette::sunkenColor() const
{
...
QColor Palette::raisedColor() const
{
...
QColor Palette::textColor() const
{
    return m_textColor;
}
...
QColor Palette::missionColor() const
{
...
QColor Palette::activeMissionColor() const
{
...
QColor Palette::groundColor() const
{
